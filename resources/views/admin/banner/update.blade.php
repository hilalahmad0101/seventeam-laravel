...
@section('content')
    ...
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            ...
            <h6 class="op-7 mb-2">Banner - <a href="{{ route('admin.category.list') }}">List</a> - Update</h6>
        </div>
                                                ...
                                                <div class="row row-cards">
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="description" class="form-control" id="description" cols="30" rows="10">{{ $banner->description }}</textarea>
                                                            @error('description')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        ...
                                                        @if ($banner->image)
                                                            <img src="{{ asset($banner->image) }}" style="width: 70px" alt="">
                                                        @endif
                                                        @error('image')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
